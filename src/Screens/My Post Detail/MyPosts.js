        ...
        return (
            <View style={{ flex: 1 }}>
                <DrawerExample navigation={this.props.navigation}>
                    <Text style={{ textAlign: 'center', fontSize: 25, marginTop: 10, marginBottom: 5 }}>My Post Detail</Text>
                    <Container>
                        <Content>
                            <Card>
                                <CardItem>
                                        ...
                                        <Text style={{ fontSize: 20 }}>Volunteers</Text>
                                            <Content style={{width:300}}>
                                                <Card >
                                                    ...
                                                    <CardItem footer>
                                    <Button style={{height:30,width:'50%',marginRight:5}} bordered success>
                                        <Text style={{textAlign:'center'}}>Donated</Text>
                                    </Button>
                                    <Button  style={{height:30,width:'50%'}} bordered success>
                                        <Text  style={{textAlign:'center'}}>Not Donated</Text>
                                    </Button>
                                </CardItem>
                                                </Card>
                                            </Content>
